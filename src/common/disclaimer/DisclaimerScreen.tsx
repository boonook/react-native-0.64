...
const source = (Platform.OS == 'ios') ? require('./html/ServiceStatement.html') : {'uri':'file:///android_asset/ServiceStatement.html'}

export default class DisclaimerScreenz extends Component{
    constructor(props) {
        super(props);
        this.state = {
            contentLoading:true
